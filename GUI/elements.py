...
def presetOptionsElement(menu) -> pGUI.dropDownMenu:
    return pGUI.dropDownMenu(left=10, top=10, width=150, height=25, backgroundColor=(192,192,192), label="Presets", autoSize=True, paddingX=10, paddingY=10, func=act.presetAction, menu=menu)
...
def presetElement() -> pGUI.button:
    return  pGUI.button(left=10, top=10, width=150, height=25, backgroundColor=(192,192,192), label="Presets", autoSize=True, paddingX=10, paddingY=10, func=act.presetAction)