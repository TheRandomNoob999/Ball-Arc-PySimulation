...
def presetElement(name, fileName, manager, textSize) -> pGUI.button:
    return  pGUI.button(left=10, top=10, width=150, height=25, backgroundColor=(192,192,192), label=name, textSize=textSize,autoSize=False, paddingX=10, paddingY=10, func=lambda: act.presetAction(fileName, manager))